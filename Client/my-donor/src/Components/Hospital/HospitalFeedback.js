...
import { feedbackHospitalPost } from "../../api/hospitalApi";
    ...
    <div>
         <Formik
                ...
                onSubmit={ (values, { setSubmitting }) => {
                  ...
                  feedbackHospitalPost(values).then(data=>console.log(console.log("signupdata data",data)));
                    console.log(values)
                     setHasUpdate(true);
                      setSubmitting(false);
